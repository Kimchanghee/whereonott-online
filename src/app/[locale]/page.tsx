      ...
      <section className="container mx-auto max-w-7xl px-4 pb-10">
        <div className="rounded-xl border border-slate-800 bg-slate-900/70 p-5">
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            <a className="rounded-lg border border-amber-400/40 bg-slate-950 p-4 hover:border-amber-300" href={buildAmazonUrl('streaming media player 4k')} target="_blank" rel="sponsored noopener noreferrer nofollow" data-affiliate-link>
            ...
            <a className="rounded-lg border border-blue-400/40 bg-slate-950 p-4 hover:border-blue-300" href={buildCoupangUrl('ott 셋톱박스')} target="_blank" rel="sponsored noopener noreferrer nofollow" data-affiliate-link>
              <p className="text-xs font-semibold uppercase tracking-wide text-blue-300">Coupang</p>
              <p className="mt-1 text-sm">OTT 셋톱박스</p>
            </a>
            <a className="rounded-lg border border-rose-400/40 bg-slate-950 p-4 hover:border-rose-300" href={buildAliExpressUrl('projector screen')} target="_blank" rel="sponsored noopener noreferrer nofollow" data-affiliate-link>
